Main.ScrollNav =
{
	...
	initLoad: function() {
		this.setupSectionHeight(true);
		
		$(window).resize(this.setupSectionHeight.bind(this, false));
		...
		$(document).on('mousewheel', this.wheel.bind(this));
		
		$(window).scroll(this.checkScroll.bind(this));
		this.checkScroll();
		
		$(window).bind('hashchange', this.hashControl.bind(this));
	},
